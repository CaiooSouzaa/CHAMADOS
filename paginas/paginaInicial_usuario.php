...
<head>
    ...
    <link rel="stylesheet" href="../css/paginaInicial_usuario.css">
</head>
...
<body>
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <a href="../paginas/paginaInicial_usuario.php" class="nav-item active">
        ...
        <div class="sidebar-footer">
            <div class="user-card">
                ...
                <div class="user-info">
                    <div class="user-name"><?php echo isset($_SESSION['nome_usuario']) ? htmlspecialchars($_SESSION['nome_usuario']) : 'Usuário'; ?></div>
                    <div class="user-role">
        ...
        <header class="topbar">
            <div class="topbar-left">
                <div class="breadcrumb">
                    <a href="../paginas/paginaInicial_usuario.php">Home</a>
            ...
            <div class="table-card animate-in delay-6">
                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            <?php
                            if (!empty($resultado_chamado_usuario) && $resultado_chamado_usuario->num_rows > 0) {
                                foreach ($resultado_chamado_usuario as $chamados) { ?>
                                    <tr>
                                ...
                                <tr>
                                    <td colspan="8" style="text-align:center; padding:24px; color:#64748b;">Nenhum chamado encontrado para você no momento.</td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <script src="../js/paginaInicial_usuario.js"></script>
