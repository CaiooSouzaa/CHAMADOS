...
<head>
    ...
    <title>Atualizar Chamado - Gestão de Chamados</title>
        ...
        <div class="content-area">
            <div class="form-container" id="container">
                ...
                <div class="form-header" id="header">
                    ...
                    <h1 id="title">Atualizar Chamado</h1>
                    <p id="subtitle">Edite as informações do chamado selecionado</p>
                </div>
                ...
                <div class="form-card" id="form-card">
                    ...
                    <div class="ticket-info" id="ticketInfo">
                        ...
                        <span>Editando chamado <strong>#<?php echo $id_chamado ? htmlspecialchars($id_chamado) : '0'; ?></strong></span>
                    </div>

                    <form action="../codigos_php/editarChamado.php" method="post" onsubmit="return handleSubmit(event)">
                        ...
                        <div class="form-group" id="fg-titulo">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" id="titulo_chamado" name="titulo_chamado"
                                    value="<?php echo $titulo_chamado ?>"
                        ...
                        <div class="form-group" id="fg-descricao">
                            ...
                            <div class="input-wrapper">
                                ...
                                <textarea id="descricao_chamado" name="descricao_chamado"
                                    placeholder="Descreva detalhadamente o problema, passos para reproduzir, e qualquer informação relevante..."
                                    required maxlength="2000"><?php echo $descricao_chamado ?></textarea>
                            </div>
                            <div class="char-counter" id="charCounter">
                                <?php echo isset($descricao_chamado) ? strlen($descricao_chamado) : '0'; ?> / 2000 caracteres
                            </div>
                        </div>
